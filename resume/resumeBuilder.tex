...
\href{https://github.com/Kash15if/react-flat-expense-record}{\faExternalLink}
...
\href{https://study-planner-phi.vercel.app/dashboard}{\faExternalLink}
...
\href{https://react-grocery-list-firebase.vercel.app/}{\faExternalLink}  {A React-based expense tracker with Firebase backend, similar to Split app. It features dark and light mode options, allowing users to manage expenses, track multiple users, and generate insightful reports..}


\item {\bf Snake and Ladder}
\href{https://vue-snake-ladder.vercel.app/}{\faExternalLink}
...
\href{https://covid19status.vercel.app/}{\faExternalLink}
...
\href{https://portfolio.kashif.world/}{\faExternalLink}
{My portfolio website built in Bootstrap, Hyml, CSS}



\item {\bf All Projects}
\href{https://myprojects.vercel.app/}{\faExternalLink}  {All Projects is being shown in the cards using github public API.}
\item 
